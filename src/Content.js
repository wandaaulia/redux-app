...
const Content = () => {
  ...
  const handleClick = (e) => {
   ...
   <div className="row mt-5 width-content-xl mx-auto content-css p-sm-3 justify-content-center p-lg-4 mb-lg-0">
          ...
          <div className=" d-flex bg-primary flex-row flex-wrap gap-3 gap-md-3 gap-lg-4 pb-1 p-xxl-3 width-xxl-persen pb-lg-5 p-3 pt-lg-5 p-md-4 p-sm-4 p-lg-5  justify-content-center align-lg-start">     
        ...
        <div className=" d-flex flex-row flex-wrap gap-3 gap-md-3 gap-lg-4 pb-1 width-xxl-persen p-xxl-3 pb-lg-5 p-3 pt-lg-5 p-md-4 p-sm-4 p-lg-5  justify-content-center align-lg-start">                 
