...
// </div>
    ...
    return (
        ...
        <div className="mt-md-3 px-xxl-5 pt-xxl-5"> 
        {
            data.map((item) => {
                return (
                   <div key={item.id} className="d-flex px-xxl-3 flex-column flex-md-row justify-content-lg-between ">
         ...
         <div className="mt-2 d-flex flex-column width-text-popular px-md-3">
